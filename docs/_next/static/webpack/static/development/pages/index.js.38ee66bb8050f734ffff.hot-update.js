...
var NavigationLink = styled_components__WEBPACK_IMPORTED_MODULE_1__["default"].a.withConfig({
  ...
  return props.menuIsOpen ? "opacity 0.4s cubic-bezier(0.65, 0.05, 0.36, 1) ".concat(0.2 + props.index * 0.1, "s, transform 0.4s cubic-bezier(0.65, 0.05, 0.36, 1) ").concat(0.2 + props.index * 0.1, "s") : "opacity 0.4s cubic-bezier(0.65, 0.05, 0.36, 1), transform 0.4s cubic-bezier(0.65, 0.05, 0.36, 1) ".concat(0.2 + props.index * 0.1, "s");
...
//# sourceMappingURL=index.js.38ee66bb8050f734ffff.hot-update.js.map