...
var NavigationLink = styled_components__WEBPACK_IMPORTED_MODULE_1__["default"].a.withConfig({
  ...
  return props.menuIsOpen ? 'translateY(0)' : 'translateY(-50%)';
}, function (props) {
  return props.menuIsOpen ? "opacity 0.25s cubic-bezier(0.65, 0.05, 0.36, 1) ".concat(0.15 + props.index * 0.05, "s, transform 0.25s cubic-bezier(0.65, 0.05, 0.36, 1) ").concat(0.15 + props.index * 0.05, "s") : "all 0.25s cubic-bezier(0.65, 0.05, 0.36, 1)";
...
//# sourceMappingURL=index.js.fb23a6e3f0ff85efeb77.hot-update.js.map