...
var NavigationLink = styled_components__WEBPACK_IMPORTED_MODULE_1__["default"].a.withConfig({
  ...
  return props.menuIsOpen ? "opacity 0.4s ease ".concat(0.2 + props.index * 0.1, "s, transform 0.4s ease ").concat(0.2 + props.index * 0.1, "s") : "opacity 0.4s ease, transform 0.4s ease ".concat(0.2 + props.index * 0.1, "s");
...
//# sourceMappingURL=index.js.391fc0b6fc9050418b51.hot-update.js.map